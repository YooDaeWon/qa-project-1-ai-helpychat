...
class MainPage:
    ...
    def wait_logged_in(self):
        ...
        return self.wait.until(EC.presence_of_element_located(self.PROFILE_ICON))
    ...
    def logout(self):
        ...
        self.wait.until(EC.visibility_of_element_located(LoginUiPage.PASSWORD_INPUT))
...
def login(driver, url, email, password):
    ...
    MainPage(driver).wait_logged_in()
    return page
