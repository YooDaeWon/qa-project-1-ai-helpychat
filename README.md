## 프로젝트 개요
- 4인 팀 프로젝트 (AI 헬피챗 QA 자동화)
- 제 담당: 입력창 입력값, 응답 영역 기본 기능 및 예외 질문 동작 / AI 답변 테스트
- **제 작업 커밋 보기**: [`유대원` 브랜치](https://github.com/YooDaeWon/qa-project-1-ai-helpychat/tree/유대원)에서 확인 가능합니다.
-  본 프로젝트가 대상으로 한 교육용 dev 서버는 현재 운영이 종료되어 접속이 불가능합니다. (실행 방법은 아래 참고용으로 남겨둡니다)
